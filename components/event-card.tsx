...
const EventCard = ({ eventId }: EventCardProps) => {
  ...
  const renderTicketStatus = () => {
    ...
    if (userTicket) {
      return (
        <div className="mt-4 flex items-center justify-between p-3 bg-orange-50 rounded-lg border border-orange-100">
          <div className="flex items-center">
          ...
          <button
            ...
            className="text-sm bg-orange-600 hover:bg-orange-700 text-white px-3 py-1.5 rounded-full font-medium shadow-sm transition-colors duration-200 flex items-center gap-1"
          >
            View your ticket
          </button>
        </div>
  ...
  return (
    <div
      ...
      className={cn(
        "bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 cursor-pointer overflow-hidden relative",
        isPastEvent ? "opacity-50 hover:opacity-80" : ""
      )}
    >
      {/* EVENT IMAGE */}
      {imageUrl && (
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="">
            <div className="flex flex-col items-start gap-2">
              {isEventOwner && (
                <span className="inline-flex items-center gap-1 bg-orange-600/90 text-white px-2 py-1 rounded-full text-xs font-medium">
          ...
          <div className="flex flex-col items-end gap-2 ml-4">
            <span
              className={cn(
                "px-4 py-1.5 font-bold rounded-md",
                isPastEvent
