...
import { createStripeConnectLoginLink } from "@/actions/stripe-connect-login";
import { createStripeConnectCustomer } from "@/actions/create-stripe-connect";
import { createStripeConnectAccountLink } from "@/actions/create-stripe-account-link";
  ...
  if (stripeConnectId === undefined) {
    return (
      <div className="flex items-center justify-center h-screen">
        <Loader message="Loading your account status..." />
      </div>
    );
  }
            ...
            <div className="bg-white p-8 rounded-lg">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex justify-center gap-4">
                  ...
                  <Link
                    href="/seller/events"
                    className="flex items-center gap-2 bg-gray-100 text-gray-700 md:px-4 md:py-2 rounded-lg hover:bg-gray-200 transition-colors py-4 px-1.5"
                  >
          ...
          {!stripeConnectId && !accountCreatePending && (
            <div className="text-center py-8 flex flex-col items-center ">
              ...
              <p className="text-gray-600 mb-6">
                Create your Stripe Connect account to start selling tickets for
                your events on Ticketly.
              </p>
              <button
                onClick={async () => {
                ...
                className="bg-orange-600 text-white px-6 py-2 rounded-lg hover:bg-orange-700 transition-colors flex items-center justify-center"
              >
