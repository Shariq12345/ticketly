...
import { Clock, OctagonXIcon, Ticket, Tickets } from "lucide-react";
...
export default function JoinQueue({
  ...
  if (queuePosition === undefined || availability === undefined || !event) {
    return <Loader message="Joining queue..." />;
  }
        ...
        <>
          {isEventOwner ? (
            ...
            <button
              ...
              className="w-full bg-orange-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-orange-700 transition-colors duration-200 shadow-md flex items-center justify-center disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              <Tickets className="size-5 mr-2" />
              Buy Ticket
            </button>
          )}
        </>
